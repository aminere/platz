    ...
    png_int_32 divisor)
{
   ...
   if (divisor != 0)
   {
      ...
      else
      {
         ...
         if (int < D) /* else overflow */
         {
            /* int.s00 is now the 64-bit product, do a standard
             * division, we know that int < D, so the maximum
            ...
            while (--bitshift >= 0)
            {
               ...
               if (int > d32)
               {
                  if (s00 < d00) --int; /* carry */
                  int -= d32, s00 -= d00, result += 1<<bitshift;
               }

               else
                  if (int == d32 && s00 >= d00)
                     int = 0, s00 -= d00, result += 1<<bitshift;
            }
